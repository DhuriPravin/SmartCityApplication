...
public class RequestGradJPanel extends javax.swing.JPanel {
    ...
    RequestGradJPanel(JPanel userProcessContainer, UserAccount userAccount, CitizensDirectory cd, EcoSystem system) {
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/edu.jpeg"))); // NOI18N
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 830, 50));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(272, 20, 310, -1));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Have you completed High School : ");
        jLabel5.setFocusable(false);
        jLabel5.setOpaque(true);
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 170, 25));
        ...
        add(highSchoolCheck, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, -1, 25));

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Enter High School Name : ");
        jLabel6.setFocusable(false);
        jLabel6.setOpaque(true);
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 170, 25));
        ...
        add(txtHighSchool, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 220, 211, 25));

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Enter High School CGPA : ");
        jLabel7.setFocusable(false);
        jLabel7.setOpaque(true);
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 270, 170, 25));
        ...
        add(txtHSgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 270, 211, 25));

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Have you completed Bachelor's : ");
        jLabel8.setFocusable(false);
        jLabel8.setOpaque(true);
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, 170, 25));
        ...
        add(highBachelorCheck, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 320, -1, 25));

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("Enter University : ");
        jLabel9.setFocusable(false);
        jLabel9.setOpaque(true);
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 370, 170, 25));
        ...
        add(txtBachelorUniv, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 370, 211, 25));

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Enter Bachelor's CGPA : ");
        jLabel10.setFocusable(false);
        jLabel10.setOpaque(true);
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 420, 170, 25));
        ...
        add(txtBachGrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 420, 211, 25));

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("Choose your concentration : ");
        jLabel11.setFocusable(false);
        jLabel11.setOpaque(true);
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, 170, 25));
        ...
        add(comboDegree, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 470, 210, 25));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 580, 80, 30));
        ...
        add(txtRecommend1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 100, 420, 20));

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Choose Desired Program : ");
        jLabel4.setFocusable(false);
        jLabel4.setOpaque(true);
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 180, 130, 25));

        add(comboProgram, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 180, 220, 25));
        ...
        add(comboUniversity, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, 220, 25));

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Choose University : ");
        jLabel12.setFocusable(false);
        jLabel12.setOpaque(true);
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 250, 130, 25));

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel13.setText("Desired Intake : ");
        jLabel13.setFocusable(false);
        jLabel13.setOpaque(true);
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 320, 130, 25));

        comboUniversity1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Spring", "Fall", "Summer" }));
        add(comboUniversity1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 320, 220, 25));

        txtAdditional.setColumns(20);
        txtAdditional.setRows(5);
        jScrollPane1.setViewportView(txtAdditional);

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 380, 220, -1));

        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel14.setText("Additional Information : ");
        jLabel14.setFocusable(false);
        jLabel14.setOpaque(true);
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 390, 130, 25));

        btnSubmit.setBackground(new java.awt.Color(102, 102, 102));
        btnSubmit.setFont(new java.awt.Font("Tahoma", 3, 11)); // NOI18N
        ...
        add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 580, 160, 30));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 580, 160, 30));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        request.setBachelorDegree((String) comboDegree.getSelectedItem());
        request.setBachelorGrade(txtBachGrade.getText());
        request.setBachelorUniv(txtBachelorUniv.getText());
        request.setDesIntake((String) comboUniversity1.getSelectedItem());
        request.setDesProgram((String) comboProgram.getSelectedItem());
        request.setDesUniv((String) comboUniversity.getSelectedItem());
        request.setHighSchool(txtHighSchool.getText());
        request.setHighschoolGrade(txtHSgrade.getText());
